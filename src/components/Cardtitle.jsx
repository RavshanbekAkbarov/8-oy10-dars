...
function Cardtitle({ name, kasb, vaqt, tavsiya, holat }) {
  return (
    <div className="bg-white w-full md:w-[750px] lg:w-[1120px] mx-auto my-5 shadow-lg rounded-lg p-4 md:p-6 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 border-l-4 border-teal-500 relative">
      {/* ✅ 1. Rasm (md da chapga suriladi) */}
      <img
      ...
      <div className="flex flex-col flex-grow text-center md:text-left">
        ...
        {/* ✅ 3. Vaqtdan keyin chiqadigan chiziq */}
